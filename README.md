...
| 9   | [**Tower of Hanoi**](./09_Tower_of_Hanoi_Puzzle/)      | Solves the classic Tower of Hanoi puzzle using both recursive and iterative approaches. This demonstrates two different paradigms for solving the same complex problem.                                                 | Recursion, Iteration, Algorithmic Thinking, Problem Solving.                                                                                               |
| 10  | [**Merge Sort**](./10_Merge_Sort_Algorithm/)           | An implementation of the Merge Sort algorithm, a highly efficient, recursive sorting algorithm that uses the "divide and conquer" strategy.                                                                             | Sorting Algorithms, Recursion, Divide and Conquer, List Slicing.                                                                                           |
...
- **Key Concepts:** Data Structures, Algorithms, File I/O, Error Handling, Time Calculation
